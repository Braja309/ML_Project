...
class DataIngestion:
    ...
    def download_housing_data(self) -> str:
        try:
            ...
            tgz_file_path = os.path.join(tgz_download_url,housing_file_name)
    ...
    def extract_tgz_file(self,tgz_file_path:str):
        try:
            ...
            logging.info(f"Extracting tgz file [{tgz_file_path}] to dir : [{raw_data_dir}]")
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            if strat_train_set is not None:
                ...
                logging.info(f"Exportig train dataset to file : [{train_file_path}]")
                strat_train_set.to_csv(train_file_path,index=False)
            if strat_test_set is not None:
                os.makedirs(self.data_ingestion_config.ingested_test_dir,exist_ok=True)
                logging.info(f"Exportig test dataset to file : [{test_file_path}]")
