...
from housing.entity.artifact_entity import DataIngestionArtifact, DataTransformationArtifact, \
    DataValidationArtifact, ModelPusherArtifact,ModelTrainerArtifact,ModelEvaluationArtifact
...
class Pipeline(Thread):
    ...
    def run_pipeline(self):
        try:
            ...
            data_transformation_artifact = self.start_data_trasformation(
                            data_ingestion_artifact=data_ingestion_artifact,
                            data_validation_artifact=data_validation_artifact
                        )
        ...
        try:
            if Pipeline.experiment.experiment_id is not None:
                ...
                experiment_dict.update({
                    ...
                    "experiment_file_path": [os.path.join(experiment.experiment_file_path)]
                })
